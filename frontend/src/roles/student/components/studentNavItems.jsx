// รายการเมนู sidebar ของนักเรียน — แยกไว้เป็นไฟล์ข้อมูลล้วน (ไม่ export component) เพื่อให้ StudentLayout
// นำไปใช้ตั้งชื่อแท็บเบราว์เซอร์ (useDocumentTitle) ได้โดยไม่ต้อง import ทั้ง StudentSidebar component
