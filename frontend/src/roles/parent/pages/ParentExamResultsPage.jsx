...
// คอร์สที่สอนจบแล้ว (COMPLETED) ไม่แสดงในหน้านี้อีกต่อไป — ดูผลการสอบย้อนหลังได้ที่หน้า "ประวัติคอร์สเรียน" แทน
  ...
  return (
    <div className="aes-page">
      <div className="aes-header">
        <div>
          <h1>ผลการสอบ</h1>
          <p>เลือกคอร์สเพื่อดูคะแนนสอบของบุตรหลานในแต่ละครั้ง (ดูได้อย่างเดียว)</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="aes-empty">
          {keyword
            ...
            : 'บุตรหลานยังไม่มีคอร์สที่กำลังเรียนอยู่ — คอร์สที่สอนจบแล้วดูได้ที่หน้า "ประวัติคอร์สเรียน"'}
        </div>
      ) : (
        <div className="aes-grid">
          {filtered.map((course) => (
            <button
              ...
              type="button"
              className="aes-card"
              onClick={() => navigate(`/parent/exam-results/${course.courseId}`)}
            >
              ...
              <span className="aes-card-cta">ดูผลการสอบ →</span>
            </button>
          ))}
        </div>
      )}
