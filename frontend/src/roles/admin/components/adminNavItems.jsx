// รายการเมนู sidebar ของแอดมิน — แยกไว้เป็นไฟล์ข้อมูลล้วน (ไม่ export component) เพื่อให้ AdminLayout
// นำไปใช้ตั้งชื่อแท็บเบราว์เซอร์ (useDocumentTitle) ได้โดยไม่ต้อง import ทั้ง AdminSidebar component
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'เพิ่มนักเรียนที่สอบติด',
        path: '/admin/student-exam-achievements',
        icon: (
          <svg viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-11a.75.75 0 00-1.5 0v2.25H7a.75.75 0 000 1.5h2.25V13a.75.75 0 001.5 0v-2.25H13a.75.75 0 000-1.5h-2.25V7z" clipRule="evenodd" />
          </svg>
        ),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
            <path fillRule="evenodd" d="M3 3.5A1.5 1.5 0 014.5 2h6.879a1.5 1.5 0 011.06.44l4.122 4.12A1.5 1.5 0 0117 7.622V16.5a1.5 1.5 0 01-1.5 1.5h-11A1.5 1.5 0 013 16.5v-13zM6 10a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h4a1 1 0 100-2H7z" clipRule="evenodd" />
          </svg>
        ),
      },
      {
