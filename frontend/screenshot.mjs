import { chromium } from 'C:/Users/kakmi/AppData/Local/npm-cache/_npx/e41f203b7505f1fb/node_modules/playwright/index.mjs';
...
// 6. Admin Dashboard (inject token so ProtectedRoute passes)
await page.setViewportSize({ width: 1440, height: 900 });
await page.goto(`${BASE}/login`, { waitUntil: 'networkidle' });
await page.evaluate(() => {
