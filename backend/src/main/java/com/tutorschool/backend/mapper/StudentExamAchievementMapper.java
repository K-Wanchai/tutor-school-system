...
public class StudentExamAchievementMapper {
    ...
    public StudentExamAchievementResponse toResponse(StudentExamAchievement achievement) {
        return StudentExamAchievementResponse.builder()
                ...
                .lowerSecondaryRoomType(achievement.getLowerSecondaryRoomType())
                .upperSecondaryProgram(achievement.getUpperSecondaryProgram())
                .faculty(achievement.getFaculty())
                .major(achievement.getMajor())
                .admissionRound(achievement.getAdmissionRound())
